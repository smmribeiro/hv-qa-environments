...
FILE=/host/builds/business-analytics/pentaho-business-analytics-9.0.0.0-241-x64.bin
...
if [ -f "$FILE" ]; then
  ...
  if curl --head --silent --fail $BUILD_HOST 2> /dev/null; then
    ...
    curl $BUILD_HOST/9.0-QAT/140/pentaho-business-analytics-9.0.0.0-241-x64.bin -o $FILE
  else
...
printf '\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\ny\n1\n\n1234567890\n1234567890\n\nn\nn\n' | /host/builds/business-analytics/pentaho-business-analytics-9.0.0.0-241-x64.bin
