...
FILE=/host/builds/business-analytics/pentaho-business-analytics-8.3.0.0-371-x64.bin
...
if [ -f "$FILE" ]; then
  ...
  if curl --head --silent --fail $BUILD_HOST 2> /dev/null; then
    ...
    curl $BUILD_HOST/8.3.0.0/371/pentaho-business-analytics-8.3.0.0-371-x64.bin -o $FILE
  else
...
echo "installing 8.3 no questions"
printf '\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\ny\n1\n\n1234567890\n1234567890\n\nn\nn\n' | /host/builds/business-analytics/pentaho-business-analytics-8.3.0.0-371-x64.bin
